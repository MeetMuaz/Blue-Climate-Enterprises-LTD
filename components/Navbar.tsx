...
const Navbar: NextPage = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className={`z-30 h-full transform inset-0 overflow-auto ease-in-out transition-all duration-150 bg-white ${
            mobileToggle ? "w-0" : "w-64"
          }`}
        >
          <div className="p-4">
            {/* close button */}
              ...
              <div className="social flex space-x-5 mt-4">
                <Link href="/">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 320 512"
                    className="h-5 w-5 text-gray-600 fill-current"
                  >
        ...
        <div className="bg-black/50 flex-1" onClick={()=>setMobileToggle(prev=>!prev)} />
      </div>
    </>
  );
};
